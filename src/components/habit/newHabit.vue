...
<template>
    <div >
        <h1 class="p-2 text-center py-2 text-2xl leading-loose font-bold">立一个新的flag</h1>
        ...
        <div class="p-2 m-2">
            <van-button plain hairline type="primary" :disabled="isDisabled" block @click="addHibit">添加</van-button>
        </div>
    </div>
</template>
